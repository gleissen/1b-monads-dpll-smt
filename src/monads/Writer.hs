...
-- This function applies comp1, comp2 and comp3 in order.
-- The Int is the main computation, the String
-- contains logs of the function we enter.
-- 
-- For now, we will not yet use the Writer monad.
--
-- The functions should append (++ or <>) the string 
...
-- Squares the passed Int and subtract 1
...
-- We'll now do the same using the Writer monad.
...
-- First, writes ".comp1"
-- Then, squares the passed Int and subtracts 1
--
